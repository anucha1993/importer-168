    ...
    <section class="bg-white dark:bg-gray-900 mb-[-80px]">
               <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                   <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-16">
                       ...
                       <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400 mt-5">
                              เรายินดีบริการทุกท่านด้วยความเชี่ยวชาญ มืออาชีพ เชื่อถือได้ทุกกระบวนการ ถูกกฎหมาย รวดเร็ว ฉับไว และซื่อตรงต่อการบริการ "ซื่อสัตย์ พัฒนา รักษาคำมั่น สรรค์สร้างบริการเป็นเลิศ คือคีย์เวิร์ด ของ TIP168
                       </p>
                   </div> 
                   <div class="grid gap-9 mb-6 lg:mb-16 md:grid-cols-2">
                       <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                           <a href="#">
                               <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" style="width: 800px" src="./images/contact/office-impoter168.jpg" alt="Bonnie Avatar">
                           </a>
                           <div class="p-5">
                               <h3 class="text-xl font-bold tracking-tight text-blue-900 dark:text-white">
                                   <a href="#">สำนักงานใหญ่</a>
                               </h3>
                               <span class="text-gray-500 dark:text-gray-400">บริษัทนำคนต่างด้าวมาทำงานในประเทศ <br> ดิ อิมพอร์ตเตอร์ 168 จำกัด</span>
                               <hr>
                               <p class="mt-1 mb-4 font-light text-gray-500 dark:text-gray-400">เลขที่ 62/231-232 ซอย ประเสริฐมนูกิจ 27 ถนน ประเสริฐมนูกิจ แขวงจรเข้บัว เขตลาดพร้าว กรุงเทพมหานคร 10230</p>
                               
                           </div>
                       </div> 
                       <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                           <a href="#">
                              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7747.045565123394!2d100.606993!3d13.840663!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30e29dbafb1b760d%3A0x4698ea6072304004!2z4Lia4Lij4Li04Lip4Lix4LiX4LiZ4Liz4LiE4LiZ4LiV4LmI4Liy4LiH4LiU4LmJ4Liy4Lin4Lih4Liy4LiX4Liz4LiH4Liy4LiZ4LmD4LiZ4Lib4Lij4Liw4LmA4LiX4LioIOC4lOC4tCDguK3guLTguKHguJ7guK3guKPguYzguJXguYDguJXguK3guKPguYwgMTY4IOC4iOC4s-C4geC4seC4lA!5e0!3m2!1sth!2sth!4v1730268452960!5m2!1sth!2sth" 
                           ...
                           <div class="p-5">
                               ...
                               <span class="text-blue-500 dark:text-gray-400">วันจันทร์ ถึง วันเสาร์ <br>  เวลา 8:30น. ถึง 17:30 น.</span>
             ...
             <section class="bg-gray-100 dark:bg-gray-900 mb-[-60px]">
              ...
              <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">
                TIP168 พร้อมวิสัยทัศน์และประสบการณ์ที่ยาวนานในวงการนี้ ช่วยชี้นำให้ทีมทำงานไปในทิศทางที่ถูกต้อง และเน้นการสร้างคุณค่าให้กับลูกค้าเป็นสำคัญ
              </p>
               </div>
             </section>
               ...
               <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                   ...
                   <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                       <div class="text-center text-gray-500 dark:text-gray-400">
                           <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="./images/contact/impoter-จิรวัฒน์.svg" alt="Bonnie Avatar">
                       ...
                       <div class="text-center text-gray-500 dark:text-gray-400">
                           <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="/images/contact/importer-สุจิตา.svg" alt="Helene Avatar">
                           <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                       ...
                       <div class="text-center text-gray-500 dark:text-gray-400">
                        <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="./images/contact/importer-อังคณา.svg" alt="Bonnie Avatar">
                           <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                               <a href="#">อังคณา (ตุ๊กกี้)</a>
                           </h3>
                           <p> ความตั้งใจ และความพยายาม
                            เพื่อทำหน้าที่ให้ดีที่สุด"</p>
                           
                       </div>
                       <div class="text-center text-gray-500 dark:text-gray-400">
                        <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="./images/contact/impoter-พัชรีพร.svg" alt="Bonnie Avatar">
                           <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                       ...
                       <div class="text-center text-gray-500 dark:text-gray-400">
                        <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="./images/contact/importer-กมลวรรณ.svg" alt="Bonnie Avatar">
                           <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                               <a href="#">กมลวรรณ (ไลลา)</a>
                           </h3>
                           <p>"ถ้าเราตั้งใจ ยังไงก็สำเร็จ"</p>
                           
                       </div>
                       <div class="text-center text-gray-500 dark:text-gray-400">
                           <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="./images/contact/importer-รสินทรา.svg" alt="Bonnie Avatar">
                           <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                       ...
                       <div class="text-center text-gray-500 dark:text-gray-400">
                        <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="./images/contact/importer-ณัฐนันท์.svg" alt="Bonnie Avatar">
                           <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                       ...
                       <div class="text-center text-gray-500 dark:text-gray-400">
                           <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="./images/contact/importer-ธัญพิมล.svg" alt="Bonnie Avatar">
                           <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
