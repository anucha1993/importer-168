                    ...
                    <form action="{{ route('customFormImport.export') }}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3 col-sm-3 ">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="labour_idcard_number" value="เลขที่บัตรชมพู"
                                            class="flat"> เลขที่บัตรชมพู 
                                    </label> <i class="fa fa-info-circle text-success" data-toggle="tooltip"
                                        data-placement="top" title="ระบุเป็น Text"></i>
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="labour_idcard_date_start" value="บัตรชมพู วันที่ออกบัตร "
                                            class="flat"> บัตรชมพู วันที่ออกบัตร 
                                    </label> <i class="fa fa-info-circle text-success" data-toggle="tooltip"
                                        data-placement="top" title="ระบุเป็น Date"></i>
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="labour_idcard_date_notify" value="บัตรชมพู วันที่หมดอายุ"
                                            class="flat">ครบกำหนดถ่ายบัตรชมพู
                                    </label> <i class="fa fa-info-circle text-success" data-toggle="tooltip"
                                        data-placement="top" title="ระบุเป็น Date"></i>
                                </div>
