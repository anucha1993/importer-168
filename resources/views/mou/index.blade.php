    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            ...
            <ul class=" space-y-4 text-gray-500 list-none list-inside dark:text-gray-400">
                ...
                <li>
                    <b>1.จัดทำเอกสารเกี่ยวกับขบวนการนำเข้าแรงงาน MOU</b>
                </li>
                <li>
                    <b>2.ควบคุมกระบวนการการนำเข้าและ ดำเนินการ เกี่ยวกับเอกสารให้ เป็นไปตามแผนการนำเข้าที่วางไว้</b>
                </li>
                <li>
                    <b>3.นำแรงงานส่งถึงที่ทำงาน ของนายจ้าง</b>
                </li>
                <li>
                    <b>4.แจ้งเข้าทำงาน แทนนายจ้าง มาตรา 13</b>
                </li>
                <li>
                    <b>5.แจ้งที่พัก ภายใน 24 ชั่วโมง มาตรา 38</b>
                </li>
            </ul>
            ...
            <ul class=" space-y-4 text-gray-500 list-none list-inside dark:text-gray-400">
                ...
                <li>
                    <b>6.ขอเลขประกันสังคม
                        และผู้เสียภาษี</b>
                </li>
                <li>
                    <b>7.ประสานงาน และดำเนินพา
                        แรงงานเปิดบัญชี</b>
                </li>
                <li>
                    <b>8.ตรวจเช็คฟรี
                ...
                <li>
                    <b>9.ต่อใบอนุญาต หลังครบ
                        2 ปีแรก</b>
                </li>
                <li>
                    <b>11.ทำรีเทิร์น หลังครบ
                        4 ปีแล้ว</b>
                </li>
                <li>
                    <b>11.แจ้งออก / หลบหนี / ส่งกลับ</b>
                </li>
            </ul>
